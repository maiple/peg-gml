...
var wasmBinaryFile = 'libpeggml.wasm';
...
function initPthreadsJS(){ PThread.initRuntime(); }
  ...
  var PThread={unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],initMainThreadBlock:function() {
        ...
        var pthreadMainJs = locateFile('libpeggml.worker.js');
  ...
  function _emscripten_fiber_init(fiber, entryPoint, userData, cStack, cStackSize, asyncStack, asyncStackSize) {
      var cStackBase = cStack + cStackSize;
  
      HEAP32[((fiber)>>2)] = cStackBase;
      HEAP32[(((fiber)+(4))>>2)] = cStack;
      HEAP32[(((fiber)+(8))>>2)] = cStackBase;
      HEAP32[(((fiber)+(12))>>2)] = entryPoint;
      HEAP32[(((fiber)+(16))>>2)] = userData;
  
      var asyncifyData = fiber + 20;
      Asyncify.setDataHeader(asyncifyData, asyncStack, asyncStackSize);
    }

  function _emscripten_fiber_init_from_current_context(fiber, asyncStack, asyncStackSize) {
      HEAP32[((fiber)>>2)] = _emscripten_stack_get_base();
      HEAP32[(((fiber)+(4))>>2)] = _emscripten_stack_get_end();
      HEAP32[(((fiber)+(12))>>2)] = 0;
  ...
  var Fibers={nextFiber:0,trampolineRunning:false,trampoline:function() {
        ...
        var stack_base = HEAP32[((newFiber)>>2)];
        var stack_max =  HEAP32[(((newFiber)+(4))>>2)];
        _emscripten_stack_set_limits(stack_base, stack_max);
  
        stackRestore(HEAP32[(((newFiber)+(8))>>2)]);
  
        var entryPoint = HEAP32[(((newFiber)+(12))>>2)];
  
        if (entryPoint !== 0) {
          writeStackCookie();
          Asyncify.currData = null;
          HEAP32[(((newFiber)+(12))>>2)] = 0;
  
          var userData = HEAP32[(((newFiber)+(16))>>2)];
          (function(a1) {  dynCall_vi.apply(null, [entryPoint, a1]); })(userData);
        } else {
...
/** @type {function(...*):?} */
var _peggml_error = Module["_peggml_error"] = createExportWrapper("peggml_error");
...
/** @type {function(...*):?} */
var _peggml_version = Module["_peggml_version"] = createExportWrapper("peggml_version");

/** @type {function(...*):?} */
var _peggml_parser_create = Module["_peggml_parser_create"] = createExportWrapper("peggml_parser_create");

/** @type {function(...*):?} */
var _peggml_parser_enable_packrat = Module["_peggml_parser_enable_packrat"] = createExportWrapper("peggml_parser_enable_packrat");
...
/** @type {function(...*):?} */
var _peggml_parse_begin = Module["_peggml_parse_begin"] = createExportWrapper("peggml_parse_begin");

/** @type {function(...*):?} */
var _peggml_parse_next = Module["_peggml_parse_next"] = createExportWrapper("peggml_parse_next");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_uuid = Module["_peggml_parse_elt_get_uuid"] = createExportWrapper("peggml_parse_elt_get_uuid");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_string = Module["_peggml_parse_elt_get_string"] = createExportWrapper("peggml_parse_elt_get_string");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_string_offset = Module["_peggml_parse_elt_get_string_offset"] = createExportWrapper("peggml_parse_elt_get_string_offset");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_string_line = Module["_peggml_parse_elt_get_string_line"] = createExportWrapper("peggml_parse_elt_get_string_line");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_string_column = Module["_peggml_parse_elt_get_string_column"] = createExportWrapper("peggml_parse_elt_get_string_column");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_choice = Module["_peggml_parse_elt_get_choice"] = createExportWrapper("peggml_parse_elt_get_choice");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_child_count = Module["_peggml_parse_elt_get_child_count"] = createExportWrapper("peggml_parse_elt_get_child_count");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_child_uuid = Module["_peggml_parse_elt_get_child_uuid"] = createExportWrapper("peggml_parse_elt_get_child_uuid");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_token_count = Module["_peggml_parse_elt_get_token_count"] = createExportWrapper("peggml_parse_elt_get_token_count");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_token_offset = Module["_peggml_parse_elt_get_token_offset"] = createExportWrapper("peggml_parse_elt_get_token_offset");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_token_string = Module["_peggml_parse_elt_get_token_string"] = createExportWrapper("peggml_parse_elt_get_token_string");

/** @type {function(...*):?} */
var _peggml_parse_elt_get_token_number = Module["_peggml_parse_elt_get_token_number"] = createExportWrapper("peggml_parse_elt_get_token_number");

/** @type {function(...*):?} */
var _peggml_get_root_uuid = Module["_peggml_get_root_uuid"] = createExportWrapper("peggml_get_root_uuid");
